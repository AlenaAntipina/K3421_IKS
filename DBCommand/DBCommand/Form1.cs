...
namespace DBCommand
{
    public partial class Form1 : Form
    {
        ...
        static string GetConnectionStringByName(string name) {
            ...
            if (settings != null) returnValue = settings.ConnectionString; return returnValue; 
        }

        private void button1_Click(object sender, EventArgs e)
        {
            sqlConnection1.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=Northwind;Integrated Security=True";
